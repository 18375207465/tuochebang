...
public class EditTuocheRequest extends BaseRequest<Object> {
    public EditTuocheRequest(String url, RequestMethod requestMethod, TuoCheRequestModel model, int status) {
        ...
        try {
            ...
            this.mParams.put("requestId", model.getRequestId());
