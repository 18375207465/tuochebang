...
import com.tuochebang.user.adapter.ReturnCarListAdapter;
...
import com.tuochebang.user.ui.returns.ReturnsDetailActivity;
...
public class ReturnsItemView extends RelativeLayout {
    ...
    /* renamed from: com.tuochebang.user.view.component.ReturnsItemView$1 */
    class C10481 implements OnRefreshListener {
        C10481() {
        }
    ...
    /* renamed from: com.tuochebang.user.view.component.ReturnsItemView$5 */
    class C10535 extends Handler {
        C10535() {
        }
    }
    ...
    private void initView(final Context context) {
        ...
        this.mSwipRefreshList.setOnRefreshListener(new C10481());
        ...
        this.mListRequest.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                if (info != null) {
                    ...
                    bundle.putSerializable(ReturnsDetailActivity.EXTRAS_RETURNS_CAR, info);
                    ActivityUtil.next((Activity) context, ReturnsDetailActivity.class, bundle);
                }
            }
        });
    }
    ...
    private void httpGetReturnsCarRequest(final XListView.XListRefreshType xListRefreshType, final boolean showLoadingView) {
        ...
        queue.add(0, request, new OnResponseListener<List<ReturnCarInfo>>() {
            ...
            /* renamed from: com.tuochebang.user.view.component.ReturnsItemView$3$1 */
            ...
            public void onFailed(int what, Response<List<ReturnCarInfo>> response) {
                ...
                ReturnsItemView.this.mDataLoadingView.setOnReloadClickListener(new C10501());
            }
        ...
        if (showLoadingView) {
            ...
            new C10535().postDelayed(new Runnable() {
                public void run() {
